...
# ../build/GENIE -g $gen -p $phen -c $covar -e $env -m G+GxE+NxE  -k 10 -jn 10  -o test.out --annot $annot -t 6 -s 1 -v
../build/GENIE_multi_pheno -v -g $gen -p ./test.2.pheno -c $covar -e $env -m G  -k 10 -jn 10  -o test.2.out --annot $annot -t 6 -tr 1
